...
namespace PoliticalParties
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PoliticalPartiesDbContext>(options => options.UseInMemoryDatabase(Configuration.GetConnectionString("ConnStr")));
            ...
            services.AddScoped<IPoliticalLeaderServices, PoliticalLeaderServices>();
            services.AddScoped<IDevelopmentRepository, DevelopmentRepository>();
            services.AddScoped<IDevelopmentServices, DevelopmentServices>();
        }
